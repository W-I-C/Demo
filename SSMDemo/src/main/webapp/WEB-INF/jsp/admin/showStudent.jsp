...
<body>
							...
							<c:forEach  items="${studentList}" var="item">
								<tr>
									...
									<td>
										...
										<button class="btn btn-default btn-xs btn-danger btn-primary" id="delete" onClick="confirmDel(${item.userid})">删除</button>
										<!--弹出框-->
									</td>
								</tr>
							</c:forEach>
						...
						<c:if test="${pagingVO != null}">
							<nav style="text-align: center">
								<ul class="pagination">
									...
									<li><a href="<%= request.getContextPath() %>/admin/showStudent?page=${pagingVO.totalCount}">共${pagingVO.totalCount}页</a></li>
								</ul>
							</nav>
						</c:if>
				    </div>
	...
	<script type="text/javascript">
        ...
        function confirmDel(userid) {
            var msg = "您真的确定要删除吗？！";
            if (confirm(msg)==true){
            	document.location="<%= request.getContextPath() %>/admin/removeStudent?id=" + userid;
            }else{
                return false;
            }
        };
