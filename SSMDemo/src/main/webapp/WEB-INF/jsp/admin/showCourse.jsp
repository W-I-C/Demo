...
<body>
							...
							<c:forEach  items="${courseList}" var="item">
								<tr>
									...
									<td>
										...
										<button  class="btn btn-default btn-xs btn-danger btn-primary" onClick="confirmDel(${item.courseid})">删除</button>
										<!--弹出框-->
									</td>
								</tr>
							</c:forEach>
	...
	<script type="text/javascript">
        ...
        function confirmDel(id) {
            var msg = "您真的确定要删除吗？！";
            if (confirm(msg)==true){
            	document.location="${pageContext.request.contextPath}/admin/removeCourse?id=" + id;
            }else{
                return false;
            }
        }
