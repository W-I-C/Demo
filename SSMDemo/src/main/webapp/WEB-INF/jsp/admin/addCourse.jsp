			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/admin/addCourse" id="editfrom" method="post">
						...
						<div class="form-group">
							<label for="inputPassword3" class="col-sm-2 control-label" id="grade">授课老师编号</label>
							<div class="col-sm-10">
						...
						<div class="form-group">
							<label for="inputPassword3" class="col-sm-2 control-label" id="coursetype">课程的类型：</label>
							<div class="col-sm-10">
						...
						<div class="form-group">
							<label for="inputPassword3" class="col-sm-2 control-label" id="grade">所属院系</label>
							<div class="col-sm-10">
